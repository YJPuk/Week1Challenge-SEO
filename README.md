...
Done in 3 commits chronologically as listed below
...
HTML Changed "div class="header"" in "body" to "header"
CSS Changed two Selectors in CSS to reflect this
CSS Removed . from the front of all selectors with header id in .Css file

HTML Changed h1 from "Hori span class="seo" seo /span n" to Horiseon , it looked awkward
CSS Removed header h1 .seo selector in CSS, serves no purpose
...
CSS Changed various CSS elements to reflect this change

CSS Optimised Css removing extra lines or combining elements with the same commands
...
HTML Changed "div class="footer"" to "footer"
CSS Changed Css .footer to footer to reflect selector changes
  
HTML Changed HTML to direct images from assets folder to Assets folder as it is case-sensitive
